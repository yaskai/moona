...
moona: raylib
ifneq (,$(moona_config))
	@echo "==== Building moona ($(moona_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f moona.make config=$(moona_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f moona.make clean
